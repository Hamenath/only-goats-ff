...
const SOCIALS = [
  { name: "Discord", handle: "Join our server", icon: Send, href: "https://discord.gg/pPTSdw8JW", color: "#5865F2", bg: "rgba(88,101,242,0.08)", border: "rgba(88,101,242,0.15)", desc: "Join 500+ members in our community server. Get match updates and announcements." },
  { name: "Instagram", handle: "@only_goats_esp", icon: InstagramIcon, href: "https://www.instagram.com/only_goats_esp/", color: "#E1306C", bg: "rgba(225,48,108,0.08)", border: "rgba(225,48,108,0.15)", desc: "Follow for highlights, match clips, and tournament updates." },
